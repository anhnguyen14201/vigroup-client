...
import { getTemplateFormFields } from '@/constants'
import {
  useLanguage,
  usePaginatedDatas,
  useProjectType,
...
import { getTemplateColumns } from '@/constants/columns/templateColumns'
const TemplateClient = () => {
  ...
  // Cột cho DataTable
  const columns = getTemplateColumns(handleEdit, handleDelete)
