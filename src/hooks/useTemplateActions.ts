...
export default function useTemplateActions({
  ...
  const handleDelete = useCallback(
    async (proj: any) => {
      dispatch(setLoading({ key: 'DeleteTemplate', value: true }))
      nProgress.start()
      ...
      try {
        ...
        dispatch(setLoading({ key: 'DeleteTemplate', value: false }))
        nProgress.done()
      }
    },
  ...
  const handleDeleteBulk = useCallback(
    async (projs: any[]) => {
      ...
      dispatch(setLoading({ key: 'DeleteTemplatesBulk', value: true }))
      nProgress.start()
      ...
      try {
        ...
        dispatch(setLoading({ key: 'DeleteTemplatesBulk', value: false }))
        nProgress.done()
      }
    },
    [dispatch, projectsData, debouncedValue],
  ...
  const handleSubmit = useCallback(
    async (values: any, selected: any) => {
      dispatch(setLoading({ key: 'UpdateTemplate', value: true }))
      nProgress.start()
      ...
      try {
        ...
        dispatch(setLoading({ key: 'UpdateTemplate', value: false }))
        nProgress.done()
      }
    },
